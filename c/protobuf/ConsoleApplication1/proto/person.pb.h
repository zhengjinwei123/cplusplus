...
class Person_Phone : public ::google::protobuf::Message {
 public:
  Person_Phone();
...
class Person : public ::google::protobuf::Message {
 public:
  ...
  inline int phonenum_size() const;
  inline void clear_phonenum();
  static const int kPhoneNumFieldNumber = 4;
  inline const ::std::string& phonenum(int index) const;
  inline ::std::string* mutable_phonenum(int index);
  inline void set_phonenum(int index, const ::std::string& value);
  inline void set_phonenum(int index, const char* value);
  inline void set_phonenum(int index, const char* value, size_t size);
  inline ::std::string* add_phonenum();
  inline void add_phonenum(const ::std::string& value);
  inline void add_phonenum(const char* value);
  inline void add_phonenum(const char* value, size_t size);
  inline const ::google::protobuf::RepeatedPtrField< ::std::string>& phonenum() const;
  inline ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_phonenum();
