...
void protobuf_AssignDesc_person_2eproto() {
	...
	Person_Phone_reflection_ =
		new ::google::protobuf::internal::GeneratedMessageReflection(
			...
			GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Person_Phone, _unknown_fields_),
			-1,
			::google::protobuf::DescriptorPool::generated_pool(),
			::google::protobuf::MessageFactory::generated_factory(),
			sizeof(Person_Phone));
...
Person_Phone* Person_Phone::New() const {
	return new Person_Phone;
}
...
::google::protobuf::uint8* Person_Phone::SerializeWithCachedSizesToArray(
...
void Person_Phone::MergeFrom(const ::google::protobuf::Message& from) {
	...
	const Person_Phone* source =
		::google::protobuf::internal::dynamic_cast_if_available<const Person_Phone*>(
			&from);
	if (source == NULL) {
		...
		case 4: {
			...
			parse_phoneNum:
				...
				::google::protobuf::internal::WireFormat::VerifyUTF8String(
					...
					this->phonenum(this->phonenum_size() - 1).length(),
					::google::protobuf::internal::WireFormat::PARSE);
			}
			else {
				goto handle_uninterpreted;
...
void Person::SerializeWithCachedSizes(
	...
	for (int i = 0; i < this->phonenum_size(); i++) {
		::google::protobuf::internal::WireFormat::VerifyUTF8String(
			this->phonenum(i).data(), this->phonenum(i).length(),
			::google::protobuf::internal::WireFormat::SERIALIZE);
		::google::protobuf::internal::WireFormatLite::WriteString(
